...
$sqlQ = "SELECT r.*, c.first_name, c.last_name, c.email, c.phone, c.address, c.slip FROM orders as r LEFT JOIN customers as c ON c.id_cus = r.customer_id WHERE r.id_order=?";
...
<div class="container">
	...
	<div class="col-12">
		...
		<?php if(!empty($orderInfo)){ 
			$slipImg = !empty($orderInfo["slip"])?'images/products/'.$orderInfo["slip"]:'';
			?>
			<div class="col-md-12">
			...
			<div class="row col-lg-12 ord-addr-info">
				...
				<p><b>Reference ID:</b> #<?php echo $orderInfo['id_order']; ?></p>
				...
				<p><b>Slip:</b>--> <?php echo $orderInfo['slip']; ?></p>
				<img src="<?php echo $slipImg; ?>" class="card-img-top" alt="...">
			...
			<div class="row col-lg-12">
				<table class="table table-hover cart">
                    ...
                    $sqlQ = "SELECT i.*, p.name, p.price, p.image
