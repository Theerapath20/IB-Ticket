                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                ตารางรายงานการสั่งซื้อสินค้า(กำลังดำเนินการ)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item"style='color:blue' href="info_order.php?id=<?=$row['id_order']?>">รายละเอียด</a></li>
                                                                    <li><a class="dropdown-item" style='color:green' href="confirm_order.php?id=<?=$row['id_order']?>"onclick="delconfirm(this.href);
                                                                    return false;">ปรับสถานะ</a></li>
                                                                    
                                                                    <li><hr class="dropdown-divider"></li>
                                                                    <li><a class="dropdown-item " style='color:red' href="cancel_order.php?id=<?=$row['id_order']?>"onclick="delcancel(this.href);
                                                                    return false;">
