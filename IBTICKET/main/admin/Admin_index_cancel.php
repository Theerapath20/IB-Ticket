                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                ตารางรายงานการสั่งซื้อสินค้า(ยกเลิกการสั่งซื้อ)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                ...
                                                                <li><a class="dropdown-item"style='color:blue' href="info_order.php?id=<?=$row['id_order']?>">รายละเอียด</a></li>
                                                                    <li><a class="dropdown-item" style='color:green' href="#cancel_order.php?id=<?=$row['id_order']?>"onclick="del(this.href);">ปรับสถานะ</a></li>
