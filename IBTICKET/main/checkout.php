			...
			<div class="row">
				...
				<div class="col-md-8 order-md-1">
					...
					<form method="post" action="cartAction.php">
						...
						<div class="mb-3">
							<label for="last_name">แนบหลักฐานการโอนเงิน</label><br>

							<label for="myfile">Select a file:</label>
							<input type="file" class="form-control" name="slip" value=" <?php echo !empty($postData['slip'])?$postData['slip']:''; ?>" required>
						</div>
